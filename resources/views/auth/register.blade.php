                        ...
                        <div class="text-center mt-4">
                            <div class="mb-3">
                                <a href="index.html" class="auth-logo">
                                    <img src="{{asset('backend/assets/images/inv.png')}}" height="50" class="logo-dark mx-auto" alt="">
                                    <img src="{{asset('backend/assets/images/inv.png')}}" height="50" class="logo-light mx-auto" alt="">
                                </a>
                            </div>
                        </div>
