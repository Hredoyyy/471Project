 ...
 <div class="page-content">
    ...
    <div class="row">
        <div class="col-12">
            <div class="invoice-title">
                ...
                <h3>
                    <img src="{{ asset('backend/assets/images/logo.png') }}" alt="logo" height="24"/> Infinity Store
                </h3>
            </div>
            <hr>
            ...
            <div class="row">
                <div class="col-6 mt-4">
                    <address>
                        <strong>Group:4-> Infinity</strong><br>
                        Brac Univertsity New Campus, Badda<br>
                        infinitystore@gmail.com
                    </address>
                </div>
    ...
    <div class="row">
        <div class="col-12">
            <div>
                <div class="p-2">
                    <h3 class="font-size-16"><strong>Purchase Report :
      ...
      @php
        ...
        @endforeach
            ...
            <tr>
                ...
                <td class="no-line text-end"><h4 class="m-0">  {{ $total_sum}}  Tk</h4></td>
            </tr>
                            </tbody>
                        </table>
                    </div>
