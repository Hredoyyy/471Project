    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="mobile_number" class="form-control" value ="{{$supplier->mobile_number}}" type="text"   >
                </div>
            </div>
            <!-- end row -->
...
<input type="submit" class="btn btn-info waves-effect waves-light" value="Update Infomation">
            </form>
